...
<p align="center">
  <img src="https://visitor-badge.laobi.icu/badge?page_id=AtthalaricNero.AtthalaricNero&left_color=0a0a0a&right_color=FFD700&left_text=Profile%20Views"  />
</p>
...
class Nero:
    def __init__(self):
        self.name = "Atthalaric Nero"
        self.role = "Backend & ML Engineer"
        self.location = "Indonesia"
        
    def current_focus(self):
        return {
            "learning": ["Python", "Machine Learning", "Backend Development", "Data Science"],
            "building": ["AI Personal Assistant", "Backend APIs", "ML Models"],
            "growing": ["Technical Skills", "Problem Solving", "Self-Mastery"]
        }
```
